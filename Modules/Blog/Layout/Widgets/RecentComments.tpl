	...
	<section id="blogRecentCommentsWidget" class="mod">
				...
				<ul>
					{iteration:widgetBlogRecentComments}
						<li>
							{option:widgetBlogRecentComments.website}<a href="{$widgetBlogRecentComments.website}" rel="nofollow">{/option:widgetBlogRecentComments.website}{$widgetBlogRecentComments.author}{option:widgetBlogRecentComments.website}</a>{/option:widgetBlogRecentComments.website}
...
{option:!widgetBlogRecentComments}
	<section id="blogRecentCommentsWidget">
		<h3>{$lblRecentComments|ucfirst}</h3>
		<ul>
			<li>{$msgBlogNoComments|ucfirst}</li>
		</ul>
	</section>
{/option:!widgetBlogRecentComments}
